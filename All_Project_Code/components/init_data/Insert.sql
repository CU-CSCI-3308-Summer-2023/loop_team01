...
insert into products (name, description, size, price, image_url, user_id) VALUES ('T-Shirt', '3 year old walmart t-shirt', 's', 5.00, 'images/walmart-tshirt.png', 2);
insert into products (name, description, size, price, image_url, user_id) VALUES ('Air Force 1s', 'Out the box af1s', '8.5', 100.00, 'images/af1.webp', 3);
insert into products (name, description, size, price, image_url, user_id) VALUES ('Jordan 1s', 'Never worn retro air jordan 1s', '12', 240.00, 'images/jordan-1s.webp', 4);
